...
const App: React.FC = () => {
  ...
  const update = () => {
    ...
    const docModelService: IEditorDocumentModelService = app.current.injector.get(IEditorDocumentModelService)
  ...
  return (
    <div style={{ width: '100%', height: '100%', padding: 8 }}>
      <div style={{ height: 40 }}>
        ...
        <Button onClick={update} style={{ marginLeft: 8 }}>更新文件</Button>
        <Button onClick={getDirty} style={{ marginLeft: 8 }}>获取未保存文件</Button>
        <Button onClick={saveAll} style={{ marginLeft: 8 }}>保存全部文件</Button>
      </div>
